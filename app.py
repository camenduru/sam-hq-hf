...
# os.system("wget https://huggingface.co/camenduru/sam-hq/resolve/main/groundingdino_swint_ogc.pth")
# os.system("wget https://huggingface.co/camenduru/sam-hq/resolve/main/sam_hq_vit_l.pth")
